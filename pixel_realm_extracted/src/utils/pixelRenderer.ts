import { CharacterAppearance, Direction, EquipmentSlots, ActionState } from '../types/game';
...
export class PixelRenderer {
   ...
   */
  public static drawHumanCharacter(
   ...
   */
  private static drawArmorOverlay(
    ctx: CanvasRenderingContext2D,
   ...
   */
  private static drawArmsAndWeapons(
    ctx: CanvasRenderingContext2D,
    appearance: CharacterAppearance,
    equipment: EquipmentSlots,
    dir: Direction,
  ...
  public static drawMonster(
    ...
    x: number,
    y: number,
    monster: { typeId: string; name: string; color: string; hp: number; maxHp: number; rarity: string; isDead: boolean },
    animTick: number
  ) {
   ...
   */
  public static drawResourceNode(
    ctx: CanvasRenderingContext2D,
    x: number,
    y: number,
    type: string,
  ...
  public static drawNPC(
    ...
    x: number,
    y: number,
    npc: { name: string; title: string; appearance: CharacterAppearance; direction: Direction },
    animTick: number
  ) {
    const dummyEquip: EquipmentSlots = {
      weapon: null,
      offhand: null,
      helmet: null,
      armor: null,
